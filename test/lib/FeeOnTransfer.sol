...
contract MockFoTERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function excludeFee(address _addr) public onlyOwner {
        isFeeExcluded[_addr] = true;
    }
    ...
    function _transfer(
        ...
        unchecked {
            if (isFeeExcluded[to]) {
                ...
                uint256 feeAmt = (amount * feePercentage) / 100;
                _balances[from] = fromBalance - amount;
                _balances[treasury] += feeAmt;
